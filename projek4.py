...
def halaman_awal():
    ...
    st.write("Aplikasi ini akan membantu Anda menghitung kebutuhan gula harian berdasarkan konsumsi buah.")
    st.image("gambar_buah.jpg")
...
# Input nama, Usia dan Berat Badan
...
def kesimpulan(usia, berat_badan, total_gula, kebutuhan_gula, nama_pengguna):
  if usia < 18:
  ...
  kesimpulan_teks = (
    f"Dengan kategori {usia_kategori} dan berat badan {berat_badan} kg, kebutuhan gula harian {nama_pengguna} adalah sekitar {kebutuhan_gula:.2f} gram.\n"
